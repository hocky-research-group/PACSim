...
def rsh_cart_0(xyz: torch.Tensor, device: torch.device):
    ...
    return torch.stack(
        [
            torch.tensor(0.282094791773878, device=device).expand(xyz.shape[:-1]),
        ],
        -1,
    )


def rsh_cart_1(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_2(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_3(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_4(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_5(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_6(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_7(xyz: torch.Tensor, device: torch.device):
...
def rsh_cart_8(xyz: torch.Tensor, device: torch.device):
