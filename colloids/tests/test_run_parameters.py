...
class TestRunParameters(object):
    @pytest.fixture
    def parameters(self):
        return RunParameters(initial_configuration="first_frame.gsd")
    ...
    def test_run_parameters(self, parameters, yaml_parameters):
        ...
        assert len(fields(parameters)) == len(fields(yaml_parameters)) == 46
        ...
        assert parameters.steric_radius_average == yaml_parameters.steric_radius_average
        assert parameters.electrostatic_radius_average == yaml_parameters.electrostatic_radius_average
...
class TestOutputPrefix(object):
    ...
    def test_prefix_resolves_all_default_filenames(self):
        ...
        assert parameters.state_data_filename == "run1/run1.state.csv"
        assert parameters.trajectory_filename == "run1/run1.trajectory.gsd"
        assert parameters.checkpoint_filename == "run1/run1.chk"
        assert parameters.final_configuration_gsd_filename == "run1/run1.final.gsd"
    ...
    def test_prefix_may_contain_directory(self):
        ...
        assert parameters.trajectory_filename == "results/run1/run1.trajectory.gsd"
    ...
    def test_prefix_survives_yaml_round_trip(self):
        ...
        assert yaml_parameters.trajectory_filename == "run1/run1.trajectory.gsd"
        assert yaml_parameters.state_data_filename == "run1/run1.state.csv"
        assert yaml_parameters.checkpoint_filename == "run1/run1.chk"
        assert yaml_parameters.final_configuration_gsd_filename == "run1/run1.final.gsd"
